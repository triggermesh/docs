The TriggerMesh Integration Language (TIL) is a configuration language based on the [HCL syntax][hcl-spec] which provides a user-friendly interface for describing [TriggerMesh Bridges][tm-brg].
